<template>
  <div class="container">
    <h1 class="header-about-ai">About the AI</h1>
    <p>
      This AI is based on the GPT-2 language model with modifications to allow conditional generation for images and classes(news categories).
